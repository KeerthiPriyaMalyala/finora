...
const inputCls  = "w-full px-4 py-2.5 rounded-xl bg-white/[0.07] border border-white/[0.12] text-white/90 placeholder-white/30 text-sm focus:outline-none focus:border-teal-400/60 focus:bg-white/[0.1] transition-all duration-200";
const selectCls = "w-full px-4 py-2.5 rounded-xl bg-slate-900/80 border border-white/[0.12] text-white/80 text-sm focus:outline-none focus:border-teal-400/60 transition-all duration-200";
      ...
      <div className="flex flex-col items-end gap-2 shrink-0">
        ...
        <div className="flex gap-1.5 opacity-0 group-hover:opacity-100 transition-all duration-200">
          <button
            ...
            className="w-7 h-7 rounded-lg flex items-center justify-center text-white/40 hover:text-teal-300 hover:bg-teal-400/15 transition-all"
            title="View details"
          >
            <Eye size={13} />
          </button>
  ...
  return (
    <div className="relative p-4 sm:p-6 space-y-6 min-h-screen" style={{ background: PAGE_BG }}>
      <style>{`
        ...
        .shimmer-box{
          background:linear-gradient(90deg,rgba(45,212,191,0.07) 0%,rgba(245,158,11,0.14) 50%,rgba(45,212,191,0.07) 100%);
          background-size:200% 100%;
          animation:shimmer 1.6s ease-in-out infinite;
          border-radius:8px;
        }
        .submit-btn{transition:all .2s ease}
        .submit-btn:hover:not(:disabled){box-shadow:0 0 28px rgba(45,212,191,0.55);transform:translateY(-1px)}
        ...
        .sort-chip:hover{border-color:rgba(45,212,191,0.5);color:rgba(255,255,255,0.8)}
        .tx-card:hover{
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-20 -right-20 w-96 h-96 rounded-full bg-amber-500/15 blur-3xl" />
        <div className="absolute top-1/2 -left-24 w-80 h-80 rounded-full bg-teal-500/12 blur-3xl" />
        <div className="absolute bottom-10 right-1/3 w-72 h-72 rounded-full bg-teal-400/8 blur-3xl" />
      </div>
